...
export const COMPOSITE_PROFILE = {
    id: "interlinked-slop-v1", version: 1, measurementRevision: "2026-09-08.3", direction: "lower-is-better", groups: COMPOSITE_GROUPS,
    ...
    hash: hashBytes(JSON.stringify(["2026-09-08.3", COMPOSITE_GROUPS, METRIC_CATALOG])),
} as const;
